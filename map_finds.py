...
class MapFinds:
    ...
    def __init__(self, iface):
        ...
        self.dlg = MapFindsDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&Map Findings')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MapFinds', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/MapFinds/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Map points for findings'),
            callback=self.run,
